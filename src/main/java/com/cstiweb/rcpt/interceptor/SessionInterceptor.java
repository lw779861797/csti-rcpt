package com.cstiweb.rcpt.interceptor;
...
public class SessionInterceptor {
    @Pointcut("within (com.cstiweb.rcpt.controller..*) && !within(com.cstiweb.rcpt.controller.AdminController)")
...
//            System.out.println("-----------用户未登录-----------");
            attributes.getResponse().sendRedirect("/login.html"); // 手动转发到/login映射路径
        }
